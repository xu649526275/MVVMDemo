package com.arms.mvvm.view.refresh;
...
import com.arms.mvvm.R;
import com.arms.mvvm.view.refresh.api.DefaultRefreshFooterCreator;
import com.arms.mvvm.view.refresh.api.DefaultRefreshHeaderCreator;
import com.arms.mvvm.view.refresh.api.DefaultRefreshInitializer;
import com.arms.mvvm.view.refresh.api.RefreshContent;
import com.arms.mvvm.view.refresh.api.RefreshFooter;
import com.arms.mvvm.view.refresh.api.RefreshHeader;
import com.arms.mvvm.view.refresh.api.RefreshInternal;
import com.arms.mvvm.view.refresh.api.RefreshKernel;
import com.arms.mvvm.view.refresh.api.RefreshLayout;
import com.arms.mvvm.view.refresh.api.ScrollBoundaryDecider;
import com.arms.mvvm.view.refresh.constant.DimensionStatus;
import com.arms.mvvm.view.refresh.constant.RefreshState;
import com.arms.mvvm.view.refresh.constant.SpinnerStyle;
import com.arms.mvvm.view.refresh.footer.BallPulseFooter;
import com.arms.mvvm.view.refresh.header.BezierRadarHeader;
import com.arms.mvvm.view.refresh.impl.RefreshContentWrapper;
import com.arms.mvvm.view.refresh.impl.RefreshFooterWrapper;
import com.arms.mvvm.view.refresh.impl.RefreshHeaderWrapper;
import com.arms.mvvm.view.refresh.listener.OnLoadMoreListener;
import com.arms.mvvm.view.refresh.listener.OnMultiPurposeListener;
import com.arms.mvvm.view.refresh.listener.OnRefreshListener;
import com.arms.mvvm.view.refresh.listener.OnRefreshLoadMoreListener;
import com.arms.mvvm.view.refresh.listener.OnStateChangedListener;
import com.arms.mvvm.view.refresh.util.DelayedRunnable;
import com.arms.mvvm.view.refresh.util.DensityUtil;
import com.arms.mvvm.view.refresh.util.SmartUtil;
import com.arms.mvvm.view.refresh.util.ViscousFluidInterpolator;
...
import static com.arms.mvvm.view.refresh.util.DensityUtil.dp2px;
import static com.arms.mvvm.view.refresh.util.SmartUtil.isContentView;
...
//    }
     ...
     * Recommended {@link com.arms.mvvm.view.refresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.arms.mvvm.view.refresh.listener.SimpleMultiPurposeListener}
     ...
     * Recommended {@link com.arms.mvvm.view.refresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.arms.mvvm.view.refresh.impl.ScrollBoundaryDeciderAdapter}
